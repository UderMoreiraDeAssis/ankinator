...
// Cada ícone aceita className para tamanho/cor (herda currentColor).
import type { ReactNode, SVGProps } from 'react';

type IconProps = { className?: string };

function Svg({ className = 'h-5 w-5', children, ...rest }: SVGProps<SVGSVGElement> & { children: ReactNode }) {
  return (
    <svg
...
export const IconSend = ({ className }: IconProps) => (
  <Svg className={className}>
    <path d="M14.54 21.69a.5.5 0 0 0 .94-.03l6.5-19a.5.5 0 0 0-.64-.64l-19 6.5a.5.5 0 0 0-.02.94l7.93 3.18a2 2 0 0 1 1.11 1.11z" />
...
// Spinner: aplique animate-spin via className.
...
export const IconFileUp = ({ className }: IconProps) => (
  <Svg className={className}>
